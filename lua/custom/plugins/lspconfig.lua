return {
  {
    ...
    config = function()
      ...
      --       -- new_config.cmd = { 'pipenv', 'run', 'pyright-langserver', '--stdio' } -- if using pyright installed within pipenv
      --       new_config.cmd = { 'pyright-langserver', '--stdio' } -- use globally installed pyright
      --     end
      --   end,
      -- }
      ...
      vim.diagnostic.config {
        ...
        virtual_text = false,
        -- virtual_text = { -- for messages after line
        -- source = 'if_many',
        -- spacing = 2,
